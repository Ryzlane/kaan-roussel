...
const goNextProject = () => {
  TweenMax.to('.next-project__title--fill', 0.3, {width: '100%'})
  TweenMax.to('.next-project__title--anim', 0.3, {transform: "scale(0.98)", delay: 0.5, onComplete: goNextProject2})
}
...
export { goNextProject, mouseHoverProject, mouseLeaveProject, loadedDone }